																				...
																				<tr>
																					...
																					<td valign="middle" style="vertical-align: middle;">
																						<div class="contentEditableContainer contentTextEditable">
																							<div class="contentEditable" style="text-align: left;font-weight: 100; color:#555555;font-size: 26px;line-height: 39px;font-family: Helvetica Neue;">
																								<h1 class="big">@lang('Arsenal')</h1>
																							</div>
																						</div>
																					</td>
																				</tr>
																					...
																					<td>
																						<div class="contentEditableContainer contentTextEditable">
																							<div class="contentEditable" style="text-align: center;">
																								<h2 style="font-size: 20px;">@lang('Заказ товара')</h2>
																								<br>
																								<div>
																									<span style="margin-right: 10px;">@lang('Имя'):</span>
																									<strong>{{ $name }}</strong>
																								</div>
																								<br><br>
																								<div>
																									<span style="margin-right: 10px;">@lang('Номер телефона'):</span>
																									<strong>{{ $phone }}</strong>
																								</div>
																								<br><br>
																								<div>
																									<span style="margin-right: 10px;">@lang('Товар'):</span>
																									<strong>{{ $product }}</strong>
																								</div>
																								<br><br>
																								<div>
																									<span style="margin-right: 10px;">@lang('Количество'):</span>
																									<strong>{{ $count }}</strong>
																								</div>
																								<br><br>
																							</div>
